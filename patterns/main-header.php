...
<!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}},"className":"lower-header wow fadeInDown"} -->
<div class="wp-block-columns are-vertically-aligned-center lower-header wow fadeInDown" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:column {"verticalAlignment":"center","width":"20%","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"className":"header-logo"} -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:navigation {"textColor":"foreground","className":"head-menu","layout":{"type":"flex","justifyContent":"left"}} -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:15%"><!-- wp:paragraph {"textColor":"foreground","className":"head-phone"} -->
<p class="head-phone has-foreground-color has-text-color">00-123-456-789</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-column is-vertically-aligned-center head-cart"><!-- wp:image {"id":12,"width":30,"sizeSlug":"full","linkDestination":"custom"} -->
